...
const Home = () => {
  return (
    <div className="max-w-7xl mx-auto max-h-[calc(100vh-60px)] h-screen grid place-content-center">
      <div className="flex px-7 sm:flex-row flex-col">
        <div className="flex-1 flex flex justify-center items-center">
          <div>
          ...
          <ul className="timeline timeline-vertical sm:hidden flex z-[30]">
            <li>
              <div className="timeline-start">Step 1</div>
              <div className="timeline-middle">
                <svg
            ...
            <li>
              ...
              <div className="timeline-end timeline-box">Browse Inventory</div>
              <hr />
            </li>
            <li>
              <hr />
            ...
            <li>
              <hr />
              <div className="timeline-start">Step 4</div>
              <div className="timeline-middle z-[30]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
